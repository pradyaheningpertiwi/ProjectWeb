...
<body>
    ...
    // Get the day name for next week in English
    $nextWeekDay = date("l", strtotime("+1 week"));
    
    // Translate the day name to Indonesian
    $nextWeekDayIndonesian = $dayMap[$nextWeekDay];
                    ...
                    <td colspan="4">
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    <p style="padding:10px;padding-left:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                        Janji Temu mendatang sampai <?php echo $nextWeekDayIndonesian; ?> Depan
                                    </p>
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                    Berikut adalah Akses cepat ke Janji Temu Mendatang hingga 7 hari<br>
                                    Detail selengkapnya tersedia di bagian @Janji Temu.
                                    </p>
                                ...
                                <td>
                                    <p style="text-align:right;padding:10px;padding-right:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                        Sesi Mendatang hingga <?php echo $nextWeekDayIndonesian; ?> Depan
                                    ...
                                    <p style="padding-bottom:19px;text-align:right;padding-right:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        Berikut Akses cepat ke Sesi Mendatang yang Dijadwalkan hingga 7 hari<br>Tambah, Hapus, dan Banyak fitur tersedia di bagian @Jadwal.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <center>
                                        <a href="appointment.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Tampilkan Semua Janji Temu</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
