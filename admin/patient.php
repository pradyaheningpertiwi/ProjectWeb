                ...
                <tr>
                    ...
                    <td>
                        <form action="" method="post" class="header-search">
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Cari nama atau email pasien" list="patient">&nbsp;&nbsp;
                            <?php
                                    ...
                                    <?php
                                        ...
                                        if($result->num_rows==0){
                                            echo '<tr>
                                                ...
                                                <br>
                                                <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Kami tidak dapat menemukan apapun terkait dengan kata kunci Anda!</p>
                                                <a class="non-style-link" href="patient.php"><button class="login-btn btn-primary-soft btn" style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Tampilkan semua Pasien &nbsp;</font></button></a>
                                                </center>
                                                <br><br><br><br>
                                                </td>
                                            </tr>';
                                                    ...
                                                    <div style="display:flex;justify-content: center;">
                                                        <a href="?action=view&id='.$pid.'" class="non-style-link">
                                                            <button class="btn-primary-soft btn button-icon btn-view" style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;">
                                                                <font class="tn-in-text">Lihat</font>
                                                            </button>
                                                        </a>
                                                    </div>
                                                    </td>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="name" class="form-label">ID Pasien: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
