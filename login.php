...
<body>
        ...
        if($result->num_rows==1){
            ...
            if ($utype=='p'){
                ...
                if ($checker->num_rows==1){
                    ...
                    $error='<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Email atau Password Salah, Coba Periksa Kembali</label>';
                }
    ...
    <div class="container">
        <table border="0" style="margin: 0;padding: 0;width: 60%;">
            <tr>
                <td>
                    <p class="header-text">Selamat Datang di ByteHealth</p>
                </td>
            </tr>
        <div class="form-body">
            <tr>
